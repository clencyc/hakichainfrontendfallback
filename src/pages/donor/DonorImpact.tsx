    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Track and measure your impact</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <div>
                <p className="text-sm text-gray-500">Cases Supported</p>
                <p className="text-2xl font-bold">{data.totalBounties}</p>
              </div>
            </div>
            <p className="text-sm text-success-600">Across multiple categories</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-success-600">Direct beneficiaries</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-success-600">Positively impacted</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <motion.div
            ...
            className="card"
          >
            <h2 className="text-xl font-bold mb-6">Monthly Contributions</h2>
            <div className="h-80">
          ...
          <motion.div
            ...
            className="card"
          >
            <h2 className="text-xl font-bold mb-6">Impact by Category</h2>
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
